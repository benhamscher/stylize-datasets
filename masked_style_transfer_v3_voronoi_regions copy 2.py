...
def main():
    ...
    parser.add_argument('--content_dirs', nargs='+', 
                       default=["/home/bhamscher/datasets/PASCALVOC/VOCdevkit/VOC2010/JPEGImages_2_split"],
    ...
    parser.add_argument('--mask_dirs', nargs='+',
                       default=['/home/bhamscher/datasets/PASCALVOC/VOCdevkit/VOC2010/SemsegIDImg_2_split'],
    ...
    for content_dir, output_dir, mask_dir in zip(content_dirs, output_dirs, mask_dirs):
        ...
        with tqdm(total=num_images) as pbar:
            for content_path in content_images[:num_images]:  
                try:
