...
def main():
    ...
    output_dirs = ['/home/bhamscher/datasets/Cityscapes_stylized_panoptic_50_percent/leftImg8bit_stylized_panoptic/train', 
                   '/home/bhamscher/datasets/Cityscapes_stylized_panoptic_50_percent/leftImg8bit_stylized_panoptic/val']
    ...
    stylize_proportion = 0.5 # Set the proportion of IDs to stylize, 1.0 for full stylization
